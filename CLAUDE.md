...
When touching this module, mind the `owns_session` invariant, the stdout-isolation rationale, `PendingTarget`'s buffer ownership and the no-debuggee guard above — all four are load-bearing and documented inline.
